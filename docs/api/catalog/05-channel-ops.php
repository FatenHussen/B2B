...
return [
    ...
    ep('EP-SC-086', 'SP-13', 'PUT', '/channel/retailers/{id}/credit', 'channel', 'sc.retailers.credit', [
        ...
        'd' => 'on_exceed: warn|block|manual_approval. block → 423 credit_limit_exceeded. manual_approval → queues EP-SC-165 then 423 with approval_id until approved+consumed. warn never blocks.',
    ]),
    ep('EP-SC-165', 'SP-13', 'GET', '/channel/credit-approvals', 'channel', 'sc.retailers.credit', [
        'name' => 'List credit approval queue',
        'name_ar' => 'طابور موافقة الائتمان',
        ...
        'd' => 'Pending rows created when on_exceed=manual_approval and confirm would exceed. status: pending|approved|rejected|consumed.',
    ]),
    ep('EP-SC-165A', 'SP-13', 'POST', '/channel/credit-approvals/{id}/decide', 'channel', 'sc.retailers.credit', [
        'name' => 'Decide credit approval',
        'name_ar' => 'قرار موافقة ائتمان',
        'b' => ['decision' => 'approve', 'reason' => 'عميل موثوق'],
        'r' => ['id' => 1, 'status' => 'approved'],
        'd' => 'decision: approve|reject. Only pending. Approve allows the next assertWithinLimit that fits the approved amount to consume the row.',
        'e' => [409 => 'illegal_transition'],
    ]),
