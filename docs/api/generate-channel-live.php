...
$pack = [
    ...
    'gotchas' => [
        ...
        'GET /channel/products list rows are only id, sku, name_ar, status. GET /channel/products/{id} returns the full editor body (pricing may be null — use PUT /products/{id}/pricing).',
        ...
        'GET /channel/dashboard KPIs are 0 / empty until DailySnapshot has a row. Never fabricate GMV. meta.snapshot_date may be null. Run GenerateDailySnapshot for demos.',
...
function notes(): array
{
    return [
        ...
        'POST /channel/zones' => 'EP-SC-131B. Upsert by zone_id. delivery_days ∈ sun…sat. Fees are decimal:0,2 not int money.',
