...
|---|---|---|---|---|---|
| AP-01 | مالية التاجر: دفعة، ملخص، كشف، تصدير، ذمم | 5 | Finance | — | ✅ 2026-09-20 |
| AP-02 | الإشعارات الموحّدة ورمز الدفع | 4 | Notification | — | ✅ 2026-09-20 |
| AP-03 | المزامنة دون اتصال | 4 | Sync | — | ✅ 2026-09-20 |
| AP-04 | بلوكات الرئيسية | 1 | Content | — | ✅ 2026-09-20 |
| AP-05 | الولاء | 2 | Loyalty | — | ✅ 2026-09-20 |
| AP-06 | إعداد التطبيق العام | 1 | Content | PA-08, PA-09, PA-15 | ✅ 2026-09-20 (defaults حتى جداول المنصة) |
...
- **وحدة:** Content. الجدول `home_blocks` (channel_id, type: banner|products|categories|offer, title, payload json, order, active_from/to). التاجر يرى بلوكات قنواته النشطة مجمّعة؛ المندوب يرى بلوكات قناته. لا مسار إدارة على `/channel/*` اليوم — البذرة أو لوحة لاحقة بعد إضافة EP للكتالوج.
...
- تطبيق المندوب حسب الكتالوج في `status/05` (يُعاد توليده بعد EP-RP-002 الرئيسية).
