...
| PA-05 | إعادة تعيين مدير القناة | 1 | Identity | PA-01 | ✅ منجز 2026-09-24 — مستمع `ChannelManagerInvited` ينشئ `ChannelUser` + عضوية + دور؛ `AssignsChannelManager` منفَّذ؛ OTP يعمل؛ إعادة التعيين تُبطل الجلسات |
