...
priority: High
contract: confirmed
endpoints: [EP-AD-035A, EP-AD-035B, EP-AD-042C, EP-AD-043B]
tables: [activity_types]
events: []
blocked_by: [BE-R01]
unblocks_frontend: [AD-43]
---

# BE-R04 — Activity types

**Endpoints:** EP-AD-035A, EP-AD-035B, EP-AD-042C, EP-AD-043B

## Requirements

1. CRUD plus status; an activity type may carry suggested root categories.
2. The activity type drives what a retailer is shown after registration.
