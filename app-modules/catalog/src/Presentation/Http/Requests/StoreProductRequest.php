...
final class StoreProductRequest extends ApiFormRequest
{
    public function rules(): array
    {
        return [
            ...
            'pricing.tax_percent' => ['nullable', 'integer', 'min:0', 'max:100'],
            ...
            'inventory.opening_stock' => ['nullable', 'array'],
            'inventory.opening_stock.*.warehouse_id' => ['required', 'integer', 'min:1'],
            'inventory.opening_stock.*.qty' => ['required', 'integer', 'min:0'],
            'inventory.opening_stock.*.variant_id' => ['nullable', 'integer', 'min:1'],
