...
final class UpdateOfferRequest extends ApiFormRequest
{
    public function rules(): array
    {
        return [
            ...
            'rules.bundle_price' => ['nullable', 'integer', 'min:0'],
            'rules.tiers' => ['nullable', 'array'],
            'rules.tiers.*.from' => ['nullable', 'integer', 'min:0'],
            'rules.tiers.*.to' => ['nullable', 'integer', 'min:0'],
            'rules.tiers.*.percent' => ['nullable', 'integer', 'min:0', 'max:100'],
